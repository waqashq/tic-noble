...
Noble.prototype.startScanning = function(serviceUuids, allowDuplicates, tic_interval, tic_window,  callback) {
  if (this.state !== 'poweredOn') {
    ...
    this._bindings.startScanning(serviceUuids, allowDuplicates, tic_interval, tic_window);
  }
};
