...
NobleBindings.prototype.startScanning = function(serviceUuids, allowDuplicates, tic_interval, tic_window) {
  this._scanServiceUuids = serviceUuids || [];

  this._gap.startScanning(allowDuplicates, tic_interval, tic_window);
};
