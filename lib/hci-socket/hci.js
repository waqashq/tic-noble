...
Hci.prototype.tic_setScanParameters = function(TIC_INTERVAL, TIC_WINDOW) {
  ...
  cmd.writeUInt16LE(TIC_INTERVAL, 5); // interval, ms * 1.6
  cmd.writeUInt16LE(TIC_WINDOW, 7); // window, ms * 1.6
